...
function parse_user_agent( $u_agent = null ) {
	...
	if( $browser == 'Iceweasel' || strtolower($browser) == 'icecat' ) {
		...
		$version = $result[UAP_KEY_VERSION][$key];
	} elseif( $find(array( Browser\IEMOBILE, Browser\EDGE, Browser\MIDORI, Browser\VIVALDI, Browser\SAMSUNGBROWSER, Browser\VALVE_STEAM_TENFOOT, Browser\CHROME, Browser\HEADLESSCHROME ), $key, $browser) ) {
		$version = $result[UAP_KEY_VERSION][$key];
